...
const UserCard = ({ user }) => {
  return (
    <div key={user?.id} className="w-[250px] px-3 py-5 shadow-md rounded-lg bg-white text-sm text-center flex flex-col items-center text-[#333333] cursor-pointer hover:scale-105">
